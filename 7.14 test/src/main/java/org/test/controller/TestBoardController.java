...
import org.test.controller.TestBoardController;
...
// 마이바티스 -> 매퍼 -> 서비스 -> 컨트롤러 순서로 가져옴
	...
	public void list(Model model) {
		log.info("TestBoardController.list 메서드 실행");
	...
	public String register(VO board, RedirectAttributes rttr) {
	...
	@GetMapping({ "/get", "/modify" }) // 192.168.111.104/board/get?bno=5
	public void get(@RequestParam("bno") Long bno, Model model) {
		// void 리턴 타임에 url이 2개인 경우 둘다 반응함 겟으로 들어오면 get.modify를 찾고 modify으로 들어오면
		// modify.modify
	...
	@PostMapping("/modify")
	public String modify(VO board, RedirectAttributes rttr) {
